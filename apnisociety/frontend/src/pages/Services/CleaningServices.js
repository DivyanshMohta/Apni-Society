...
const CleaningServices = () => {
  ...
  const handleAppointmentSubmit = async (e) => {
    ...
    if (name && contact && appointmentDate && wing && flat) {
      try {
        ...
        await addDoc(collection(db, "cleaningAppointments"), {
          name: name,
          contact: contact,
  ...
  const fetchAppointments = async () => {
    setLoading(true);
    try {
      const querySnapshot = await getDocs(collection(db, "cleaningAppointments"));
  ...
  const handleCancelAppointment = async (id) => {
    try {
      await deleteDoc(doc(db, "cleaningAppointments", id));
  ...
  return (
    <div className="cleaning-services">
      ...
      <p>Request cleaning services for various cleaning issues in your home.</p>

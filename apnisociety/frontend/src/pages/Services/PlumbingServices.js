...
const PlumbingServices = () => {
  ...
  const handleAppointmentSubmit = async (e) => {
    ...
    if (name && contact && appointmentDate && wing && flat) {
      try {
        ...
        await addDoc(collection(db, "plumbingAppointments"), {
          name: name,
          contact: contact,
  ...
  const fetchAppointments = async () => {
    setLoading(true);
    try {
      const querySnapshot = await getDocs(collection(db, "plumbingAppointments"));
  ...
  const handleCancelAppointment = async (id) => {
    try {
      await deleteDoc(doc(db, "plumbingAppointments", id));
  ...
  return (
    <div className="plumbing-services">
      ...
      <p>Request plumbing services for various plumbing issues in your home.</p>

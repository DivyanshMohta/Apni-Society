            ...
            <div className="form-container sign-up">
                <form>
                    ...
                    <div className="social-icons">
                        ...
                        <a href="#" className="icon" data-tooltip="GitHub"><i className="fa-brands fa-github"></i></a>
                        <a href="#" className="icon" data-tooltip="LinkedIn"><i className="fa-brands fa-linkedin-in"></i></a>
                    </div>
